    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Design and launch targeted marketing campaigns</p>
        </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-xl font-semibold text-gray-900">Select Audience Segments</h2>
                  <span className="text-sm text-gray-500 ml-2">
                    ({filteredSegments.length} total segments)
                  </span>
                </div>
              ...
              {showFilters && (
                <div className="mb-6 p-4 bg-gray-50 rounded-lg border">
                  <div className="flex items-center gap-4">
                    <label className="text-sm font-medium text-gray-700">Customer Count:</label>
                    <select
                    ...
                    {segments
                      ...
                      .map(segment => (
                        <div key={segment._id} className="flex justify-between items-center text-xs">
                          ...
                          <span className="text-gray-500">{segment.customers.toLocaleString()}</span>
                        </div>
                      ))}
                  </div>
                </div>
